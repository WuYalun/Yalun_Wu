const I18N = {
  zh: {
    ...
    about_title: "简介",
    about_p1:
      "我是吴亚伦，目前在新加坡国立大学攻读计算机硕士，所属 NExT++ Lab。研究聚焦可信大模型系统与 Agent 架构，覆盖多步 RAG、Agent 自进化、记忆治理、高约束场景评测与业务智能落地。",
    about_p2:
    ...
    edu_extra: "相关课程：数据结构、机器学习、深度学习、强化学习。语言：雅思 6.5；GRE 322（V152 / Q170）。",
    pub_title: "论文与项目",
    pub_note: "已发表论文按会议标注；在投与撰写中的工作单独标明状态，不视为已接收。",
    filter_all: "全部",
    ...
    status_cikm: "一轮评审后修改中 · 预计投稿 ICASSP 2027",
    status_emnlp_demo: "一轮评审后修改中 · 预计投稿 NAACL 2027",
    status_emnlp: "一轮评审后修改中 · 预计投稿 CVPR 2027",
    ...
    exp_huazhu_2: "探索有限上下文下可解释、可校验的 skill 生成；相关工作扩展为 ProcuraClaw，一轮评审后修改中，预计投稿 ICASSP 2027。",
  ...
  en: {
    ...
    about_title: "About",
    about_p1:
      "I am Yalun Wu, a Master of Computing student at NUS NExT++ Lab. My work focuses on trustworthy LLM systems and agent architectures, spanning multi-step RAG, agent self-evolution, memory governance, high-constraint evaluation, and business intelligence deployment.",
    about_p2:
    ...
    chip_agent: "LLM agents",
    chip_memory: "Memory governance",
    chip_rag: "Multi-step / visual RAG",
    chip_eval: "Trustworthy evaluation",
    chip_safety: "Safety-constrained embodied tasks",
    edu_title: "Education",
    ...
    edu_extra: "Coursework: data structures, machine learning, deep learning, reinforcement learning. IELTS 6.5; GRE 322 (V152 / Q170).",
    pub_title: "Publications & projects",
    pub_note: "Venue labels follow the CV. Under-review and in-preparation manuscripts are marked explicitly and should not be read as acceptances.",
    filter_all: "All",
    filter_agent: "Agent / RAG",
    ...
    status_cikm: "Revising after one review round · targeting ICASSP 2027",
    status_emnlp_demo: "Revising after one review round · targeting NAACL 2027",
    status_emnlp: "Revising after one review round · targeting CVPR 2027",
    ...
    exp_huazhu_2: "Explored interpretable skill generation under limited context; later extended into ProcuraClaw (revising after one review round, targeting ICASSP 2027).",
